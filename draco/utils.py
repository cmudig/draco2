...
def asp_to_vl(facts):
    ...
    for e in encodings:
        ...
        if "bin" in enc:
            encoding[enc["channel"]]["bin"] = (
                True if int(enc["bin"]) == 10 else {"maxbins": int(enc["bin"])}
            )
...
if __name__ == "__main__":
    ...
    data = [
        ...
        {"yield": 32.0, "variety": "Peatland", "year": 1931, "site": "Duluth"},
        {
            "yield": 24.66667,
            "variety": "No. 475",
            "year": 1931,
        ...
        {"yield": 47.0, "variety": "No. 462", "year": 1932, "site": "Morris"},
        ...
        {"yield": 30.0, "variety": "No. 475", "year": 1932, "site": "University Farm"},
