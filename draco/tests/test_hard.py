...
def test_shape_with_cardinality_gt_eight():
    ...
    # cannot use shape encoding for cardinality > 8
    assert (
        list_violations(
            p
            + """
    ...
    """
        ...
        == ["shape_with_cardinality_gt_eight"]
    )


def test_color_with_cardinality_gt_twenty():
    ...
    # cannot use color encoding for cardinality > 20
    assert (
        list_violations(
            p
            + """
